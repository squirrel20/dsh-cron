 ...
 * `command` task spawns a process, and a plugin-registered `callback` task
 * calls its provider's own function in this process. This is deliberately NOT dsh-schedule:
