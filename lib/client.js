						...
						(() => {
							...
							return h("div", { className: "dshCron_field" },
								...
								trigMode === "hourly" ? h("div", { className: "dshCron_inputRow" },
									h("input", { className: "dshCron_input dshCron_mono", style: { flex: "0 0 auto", width: "88px" }, type: "number", min: 0, max: 59, value: minute, "aria-label": t("form.minute"), onChange: (event) => setMinute(event.target.value) }),
