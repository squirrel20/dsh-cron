			...
			return h(react.Fragment, {},
				h(primitives.Modal, {
					...
					h("div", { className: "dshCron_form" },
						...
						(() => {
							// One time-zone control shared by every zone-carrying branch; only
							// one branch renders per pass, so the single element is safe.
							const zoneInput = h("input", { className: "dshCron_input", style: { flex: 1 }, value: timeZone, "aria-label": t("form.timezone"), onChange: (event) => setTimeZone(event.target.value) });
							const clockInput = h("input", { className: "dshCron_input dshCron_mono", style: { flex: 1 }, type: "time", value: timeOfDay, "aria-label": t("form.timeOfDay"), onChange: (event) => setTimeOfDay(event.target.value) });
							return h("div", { className: "dshCron_field" },
								...
								trigMode === "hourly" ? h("div", { className: "dshCron_inputRow" },
									h("input", { className: "dshCron_input dshCron_mono", style: { flex: 1 }, type: "number", min: 0, max: 59, value: minute, "aria-label": t("form.minute"), onChange: (event) => setMinute(event.target.value) }),
									h("span", { className: "dshCron_unit" }, t("form.minute.unit")),
									zoneInput) : null,
								trigMode === "daily" || trigMode === "weekdays" ? h("div", { className: "dshCron_inputRow" },
									clockInput,
									zoneInput) : null,
								trigMode === "weekly" ? h("div", { className: "dshCron_inputRow" },
									h("select", { className: "dshCron_input", style: { flex: 1 }, value: weekday, "aria-label": t("form.weekday"), onChange: (event) => setWeekday(event.target.value) },
								...
								trigMode === "custom" ? h("div", { className: "dshCron_inputRow" },
									...
									trigger === "at" ? h("input", { className: "dshCron_input", type: "datetime-local", value: at, "aria-label": t("form.at"), onChange: (event) => setAt(event.target.value) }) : null) : null);
						})(),
